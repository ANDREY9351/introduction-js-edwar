let result;
// Math es una plantilla clase y permite sacar metodos que sacamos 5, y random
...
// cuatro operaciones basicos con dos numeros enteros aleatorios no mayores a 100

let num1 = result;
result = Math.floor(Math.random() * 50); // numero aleatroiio entre o y 100 
let num2 = result;
result = Math.floor(Math.random() * 50); // numero aleatorio entre 0 y 100

console.log(num1, num2);

let sil = 'Abajo estan las operaciones basicas';
console.log(sil);
